...
from pages.system_administrator import dashboard, manage_user, configure_system_settings, reports, manage_subscriptions, manage_aplications, manage_hospital
